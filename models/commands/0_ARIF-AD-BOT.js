...
module.exports.run = async({api,event,args}) => {
    ...
    if (args[0] == "admin") {
        var callback = () => api.sendMessage(
            {body:`┄┅══❁ADMIN BOT❁══┅┄
   [1] NAME: 𒁍 ANURAG
   [2] Facebook: 𒁍 https://www.facebook.com/profile.php?id=61578840237242
   [3] Thanks for using 𒁍 ${global.config.BOTNAME} bot`,
            attachment: fs.createReadStream(__dirname + "/cache/1.png")}, 
            event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.png")
        );  
        return request(encodeURI(`https://graph.facebook.com/61578840237242/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
