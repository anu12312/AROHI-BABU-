...
react.includes("😅") ||
react.includes("🤤") || react.includes("😀") || react.includes("🤨") || react.includes("hasipay") || react.includes("Hasipay") || react.includes("fuck") || react.includes("fuckyou") || react.includes("vuda") || react.includes("Vuda") || react.includes("bold") || react.includes("Bold") || react.includes("am") || react.includes("nan") || react.includes("Am") || react.includes("Xuda Xudi") || react.includes("gagi") || react.includes("bastos") || react.includes("Bastos") || react.includes("deputa") || react.includes("Deputa") || react.includes("puta") || react.includes("Puta") || react.includes("Pota") || react.includes("baboy") || react.includes("kababuyan") || react.includes("🖕") || react.includes("🤢") || react.includes("😝") || react.includes("hayup") || react.includes("hayop") || react.includes("nigga") || react.includes("Nigga") || react.includes("script kiddie") || react.includes("trash") || react.includes("Hayop") || react.includes("Hayup") || react.includes("kagagohan") || react.includes("kagaguhan") || react.includes("Nan") || react.includes("kingina") || react.includes("Kingina") || react.includes("KINGINA") || react.includes("hindot") ||  react.includes("abno") || react.includes("Abno") || react.includes("Script kiddie") || react.includes("lunch") || react.includes("fb") || react.includes("Inbox") || react.includes("xd") || react.includes("ib") || react.includes("Group") || react.includes("sona") || react.includes("khana") || react.includes("sab") || react.includes("breakfast") || react.includes("shona") || react.includes("tum") || react.includes("mai") || react.includes("janu") || react.includes("jan") || react.includes("Ho") || react.includes("kese") || react.includes("Babu")) {
    var msg = {
				body: ""
			}
